...
public class Arena extends Levels{
	...
	public Arena(Game game) {
        ...
        timeSincePower = 0f;
        isComplete = false;
        //player2 = new Player(game, "src/resources/8bitshipfinalS2.png");
        redBubble1 = new RedBubble(game);
		background = new Background(game, new Vec2(400, -160), "src/resources/backgroundspace2.png");
        asteroid1 = new Background(game, new Vec2(50, -35), "src/resources/asteroid1.2.png");
        asteroid2 = new Background(game, new Vec2(50, -25), "src/resources/asteroid2.2.png");
		game.getPlayer().setGravityStrength(1);
	}
	/*
	public Player getPlayer2Arena() {
		return player2;
	}
	*/
	...
	public void playMusic() {
        ...
        try {
            ...
            paprika = new SoundClip("src/resources/l1.au");
            paprika.loop();
        }
        catch (Exception ex) {
	...
	public void populate() {        
        ...
        backgroundJ.setPosition(new Vec2(400, 1645));
        ...
        cornerL.setImage(new BodyImage("src/resources/iron1.png", new Vec2 (22.5f, 22.5f), 1f));
        ...
        cornerR.setImage(new BodyImage("src/resources/iron3.png", new Vec2(-22.5f,22.5f), 1f));
        ...
        cornerT.setImage(new BodyImage("src/resources/iron2.png", new Vec2(22.5f,-22.5f), 1f));
	...
	{
        game.getPlayer().setPosition(new Vec2(300, 0));
	}
	public void putPlayerAtStart2() {
        game.getPlayer2().setPosition(new Vec2(100, 0));
	}
}
